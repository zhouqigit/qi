...
//	private static final String appsecret="360305a7efd93023a6461bf9eb7ecc63";
	...
	private static String accessToken="ppq7m8T1LThkB01bATFK_k5_nsNm24oms3YKm2BwKmnEOG9SMenw-KkCiI9e4hH5vGQ7epsz85kgss-GsY-QyEqqwo8dMOlQntc8m1byu9-5FYbhIZbJdkVOUQUyZ-9MQZNhAHAYHV";
...
//		textMap.put("", "");
	...
	public void add_news() throws Exception{
		...
		dataMap.put("thumb_media_id", "YCwrnYUqNjx4u2Jl_5HfLXz-AV92RoZrEHCMrV5HVW4");
	...
	public void uploadnews() throws Exception{
		List<Map<String, String>> lisDataMap=new ArrayList<Map<String, String>>();
		Map<String, String> dataMap=new HashMap<String, String>();
		dataMap.put("thumb_media_id", "YCwrnYUqNjx4u2Jl_5HfLbelKeiduc8ZIJvwL2lTAJo");
...
//		sbu.append("\"media_id\":\"YCwrnYUqNjx4u2Jl_5HfLTV8wXG1n8bLOQGcGVb94Hc\"");
		...
		sbu.append("}");
		sbu.append("}");*/
		String jsonstr="{\"touser\":[\"oAhBss23b5IaMf-D8ljqdxkLSM40\",\"oAhBss6Imvijmyb-gTikYMYZTWDQ\"],\"msgtype\":\"text\",\"text\":{\"content\":\"hello from boxer.\"}}";
